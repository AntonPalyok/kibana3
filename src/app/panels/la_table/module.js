/** @scratch /panels/5
 *
 * include::panels/la_table.asciidoc[]
 */

/** @scratch /panels/la_table/0
 *
 * == la_table
 * Status: *Stable*
 *
 * The la_table panel contains a sortable, pagable view of documents that. It can be arranged into
...
function (angular, app, _, kbn, moment) {
  ...
  var module = angular.module('kibana.panels.la_table', []);
  app.useModule(module);

  module.controller('la_table', function($rootScope, $scope, $modal, $q, $compile, $timeout,
    ...
    $scope.panelMeta = {
      ...
      editorTabs : [
        {
          title:'Paging',
          src: 'app/panels/la_table/pagination.html'
        },
        {
          title:'Queries',
      ...
      status: "Stable",
      description: "A paginated la_table of records matching your query or queries. Click on a row to "+
        "expand it and review all of the fields associated with that document. <p>"
    };

    // Set and populate defaults
    var _d = {
      /** @scratch /panels/la_table/5
       * === Parameters
       *
      ...
      offset  : 0,
      /** @scratch /panels/la_table/5
       * sort:: An array describing the sort order of the la_table. For example [`@timestamp',`desc']
       */
      sort    : ['_score','desc'],
      /** @scratch /panels/la_table/5
      ...
      overflow: 'min-height',
      /** @scratch /panels/la_table/5
       * fields:: the fields used a columns of the la_table, in an array.
       */
      fields  : [],
      /** @scratch /panels/la_table/5
      ...
      sortable: true,
      /** @scratch /panels/la_table/5
       * header:: Set to false to hide the la_table column names
       */
      header  : true,
      /** @scratch /panels/la_table/5
       * paging:: Set to false to hide the paging controls of the la_table
       */
      paging  : true,
      /** @scratch /panels/la_table/5
       ...
       * consideration the number of columns in the la_table. For example, a trimFactor of 100, with 5
       * columns in the la_table, would trim each column at 20 character. The entirety of the field is
